...
###Modelo SVM lineal (Support Vector Machine)
...
#####################################
#SVM lienal (Support Vector Machine)#
#####################################
...
- Accuracy (Exactitud): La exactitud global del modelo es del 83.65%, lo que indica que clasificó correctamente el 83.65% de todos los casos. El intervalo de confianza del 95% (0.7697, 0.8903) sugiere na confianza moderada en esta estimación. Notablemente menor que el modelo anterior.
...
- Valor P [Exactitud > Tasa de No Información]: El valor p < 2.2e-16 es extremadamente significativo. Esto indica que la exactitud del modelo es significativamente superior a la tasa de no información (.3774).
...
##################################
 ...
 Estadísticas Globales
- Accuracy (Exactitud): La exactitud global del modelo es del 98.74%, lo que indica que clasificó correctamente el 98.74% de todos los casos. El intervalo de confianza del 95% (0.9553, 0.9985) sugiere na alta confianza en esta estimación.
